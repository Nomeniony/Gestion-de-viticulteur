                                    ...
                                    {?>
                                        <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <input type="text" name="Nom_et_Prenom_vit" value="<?php echo $row["nom"].' '.$row["PRENOM"];?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <input type="text" name="CIN_vit" value='<?php echo $row["CIN"];?>'>
                                ...
                                ?>
                                        <table border=1>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $ligne['PU']; ?>Ar</td>
                                                <td>
                                                    <input type="number" name="Poids_brut" value=0 placholder='Poids brute du raisins'>
                                                </td>
                                                <td>
                                                    <input type="number" name="Nombre_fut" value=0 id="" placeholder='Nombre de fut'>
                                                </td>
                                                <td>
                                                    <input type="number" name="Nombre_garaba" value=0 id="" placeholder='Nombre de Graba'>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td><?php echo $ligneB['PU']; ?>Ar</td>
                                                <td>
                                                    <input type="number" name="Poids_brut1" value=0 placholder='Poids brute du raisins'>
                                                </td>
                                                <td>
                                                    <input type="number" name="Nombre_fut1" value=0 id="" placeholder='Nombre de fut'>
                                                </td>
                                                <td>
                                                    <input type="number" name="Nombre_garaba1" value=0 id="" placeholder='Nombre de Graba'>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td><?php echo $ligneG['PU'] ?>Ar</td>
                                                <td>
                                                    <input type="number" name="Poids_brut2" value=0 placholder='Poids brute du raisins'>
                                                </td>
                                                <td>
                                                    <input type="number" name="Nombre_fut2" value=0 id="" placeholder='Nombre de fut'>
                                                </td>
                                                <td>
                                                    <input type="number" name="Nombre_garaba2" value=0 id="" placeholder='Nombre de Graba'>
                                                </td>
                                            </tr>
                                        </table>
                                    <?php
